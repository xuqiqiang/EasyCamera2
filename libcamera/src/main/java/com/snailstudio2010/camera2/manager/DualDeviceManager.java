...
public class DualDeviceManager extends DeviceManager {
    ...
    private CameraDevice.StateCallback stateCallback = new CameraDevice.StateCallback() {
        ...
        public void onOpened(@NonNull CameraDevice camera) {
            ...
            if (camera.getId().equals(mCameraId)) {
                ...
                Logger.e(TAG, "internal error, camera id not match any requested camera id");
            }
    ...
    public DualDeviceManager(Context context, Properties properties, JobExecutor executor, CameraEvent event) {
